...
return new class extends Migration
{
    private array $observationTables = [
        'batanes_tbl', 'baua_tbl', 'fuyot_tbl', 'magapit_tbl', 'mariano_tbl',
    ...
    public function up(): void
    {
        ...
        foreach ($this->observationTables as $table) {
            $this->addIndexIfPossible($table, ['protected_area_id'], "idx_{$table}_protected_area_id");
    ...
    public function down(): void
    {
        ...
        foreach ($this->observationTables as $table) {
            $this->dropIndexIfExists($table, "idx_{$table}_protected_area_id");
